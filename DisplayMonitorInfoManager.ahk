...
class DisplayMonitorInfoManager
{
    ...
    initialize()    {
        ...
        this._info:=[]
        this._lpfnEnum:=registerCallback("displayMonitorInfoManager_EnumDisplayMonitorsProc_A9763F99","Fast") ;  Routes to this.enumDisplayMonitorsProc()
        dllCall("User32.dll\EnumDisplayMonitors", "Ptr",0, "Ptr",0, "Ptr",this._lpfnEnum, "Ptr",0)
...
displayMonitorInfoManager_EnumDisplayMonitorsProc_A9763F99(unnamedParam1, unnamedParam2, unnamedParam3, unnamedParam4)    {
    return DisplayMonitorInfoManager.enumDisplayMonitorsProc(unnamedParam1, unnamedParam2, unnamedParam3, unnamedParam4)
}